#### Master Build Status
[![Build Status](https://travis-ci.org/wcodecoin/wcodecoin.svg?branch=master)](https://travis-ci.org/wcodecoin/wcodecoin) [![Build status](https://ci.appveyor.com/api/projects/status/github/wcodecoin/wcodecoin?branch=master&svg=true)](https://ci.appveyor.com/project/RocksteadyTC/wcodecoin)

#### Development Build Status
[![Build Status](https://travis-ci.org/wcodecoin/wcodecoin.svg?branch=development)](https://travis-ci.org/wcodecoin/wcodecoin) [![Build status](https://ci.appveyor.com/api/projects/status/github/wcodecoin/wcodecoin?branch=development&svg=true)](https://ci.appveyor.com/project/RocksteadyTC/wcodecoin)
...
- `cd <your_wcodecoin_directory>`
- `mkdir build`
- `cd build`
- `set PATH="C:\Program Files (x86)\Microsoft Visual Studio\2017\Community\Common7\IDE\CommonExtensions\Microsoft\CMake\CMake\bin";%PATH%`
- `cmake -G "Visual Studio 15 2017 Win64" .. -DBOOST_ROOT=C:/local/boost_1_68_0`
- `MSBuild wcodecoin.sln /p:Configuration=Release /m`
...
- `MSBuild wcodecoin.sln /p:Configuration=Release /p:Platform=Win32 /m`

The binaries will be in the `src/Release` folder when you are complete.

- `cd src`
- `cd Release`
- `wcodecoind.exe --version`

#### Thanks
Cryptonote Developers, Bytecoin Developers, Monero Developers, Forknote Project, wcodecoin Community
...
// Copyright (c) 2018-2019, The wcodecoin Developers
//
